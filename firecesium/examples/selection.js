...
var rxFiresLayer = new ol.layer.Vector({
  ...
  source: new ol.source.Vector({
    ...
    url: 'https://gbcc.us/or-coc_rxfires.geojson'
...
var newFiresLayer = new ol.layer.Vector({
  ...
  source: new ol.source.Vector({
    ...
    //     +"&token=" + irwin
    url: 'https://gbcc.us/or-coc_newfires.geojson'
  }),
  visible: true,
  wrapX: false,
...
var ongoingFiresLayer = new ol.layer.Vector({
  ...
  source: new ol.source.Vector({
    format: new ol.format.GeoJSON(),
    crossOrigin: 'anonymous',
    url: 'https://gbcc.us/or-coc_ongoingfires.geojson'
    // url: "https://irwin.doi.gov/arcgis/rest/services/Irwin/FeatureServer/0/query?f=geojson"
...
var geomacPerimsLayer = new ol.layer.Vector({
  ...
  source: new ol.source.Vector({
    format: new ol.format.GeoJSON(),
    crossOrigin: 'anonymous',
    url: 'https://gbcc.us/or-coc_geomacperims.json'
  }),
  style: new ol.style.Style({
    stroke: new ol.style.Stroke({
...
var vectorLayer = new ol.layer.Vector({
  ...
  source: new ol.source.Vector({
    ...
    crossOrigin: 'anonymous',
    url: 'firecesium/examples/data/topojson1/or-coc.topojson',
    format: new ol.format.TopoJSON()
